      ...
      <table class="table table-hover" id="table" style='width:1000px'>
         ...
         <c:forEach var="reserve" items="${reserveList}">
            <tr>
               ...
               <td>${reserve.reserveSTime}</td>
               <td>${reserve.reserveETime}</td>
               <td>
               <c:set var="rno" value="${reserve.roomNo}" />
               <c:if test="${rno eq 1}">
                  <c:out value="1번 4인실" />
               </c:if>
               <c:if test="${rno eq 2}">
               ...
               <td>
               <c:set var="bno" value="${reserve.branchNo}" />
               <c:if test="${bno eq 1}">
                  <c:out value="대구알파시티점" />
               </c:if>
               <c:if test="${bno eq 2}">
               ...
               <td>${reserve.price}원</td>
               <td><input type="button" class="btn2" onclick="reservedelete(${reserve.reserveNo})" value="취소" /></td>               
            </tr>
         </c:forEach>
         </tbody>
      </table>      
