...
<br><br>
   <div id="con">
      <div id="reserve">
         <div id="reserve_form">
            <form>
               <h3 class="login" style="letter-spacing: -1px;">Reservation Condition (대구 만촌점)</h3>
               <input type="button" class="btn3" onclick="location.href='reserveConfirmAlpha.do'" value="대구 알파시티점 보기" />
      ...
      <table class="table table-hover" id="table" style='width:1000px'>
         ...
         <tbody>
         <c:forEach var="reserveMan" items="${reserveConfirmMan}">
            <tr>
               <td>${reserveMan.reserveNo}</td>
               <td>${reserveMan.userId}</td>
               <td>${reserveMan.userName}</td>               
               <td>${reserveMan.userPhone}</td>
               <td><fmt:formatDate value="${reserveMan.reserveDate}" pattern="yyyy-MM-dd" /></td>
               <td>${reserveMan.reserveSTime}</td>
               <td>${reserveMan.reserveETime}</td>
               <td>
               <c:set var="rno" value="${reserveMan.roomNo}" />
               <c:if test="${rno eq 1}">
                  <c:out value="1번 4인실" />
               </c:if>
               <c:if test="${rno eq 2}">
               ...
               <td>
               <c:set var="bno" value="${reserveMan.branchNo}" />
               <c:if test="${bno eq 1}">
                  <c:out value="대구알파시티점" />
               </c:if>
               <c:if test="${bno eq 2}">
