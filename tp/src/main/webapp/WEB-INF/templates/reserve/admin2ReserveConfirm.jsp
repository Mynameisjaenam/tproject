...
<br><br>
   <div id="con">
      ...
      <table class="table table-hover" id="table" style='width:1000px'>
         ...
         <tbody>
         <c:forEach var="admin2reserve" items="${admin2ReserveList}">
            <tr>
               <td>${admin2reserve.reserveNo}</td>
               <td>${admin2reserve.userId}</td>
               <td>${admin2reserve.userName}</td>               
               <td>${admin2reserve.userPhone}</td>
               <td><fmt:formatDate value="${admin2reserve.reserveDate}" pattern="yyyy-MM-dd" /></td>
               <td>${admin2reserve.reserveSTime}</td>
               <td>${admin2reserve.reserveETime}</td>
               <td>
               <c:set var="rno" value="${admin2reserve.roomNo}" />
               <c:if test="${rno eq 1}">
                  <c:out value="1번 4인실" />
               </c:if>
               <c:if test="${rno eq 2}">
               ...
               <td>
               <c:set var="bno" value="${admin2reserve.branchNo}" />
               <c:if test="${bno eq 1}">
                  <c:out value="대구알파시티점" />
               </c:if>
               <c:if test="${bno eq 2}">
